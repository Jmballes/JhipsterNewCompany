...
public class MessageService {
    ...
    public Page<Message> findAllByOrderByIdDesc(Pageable pageable){
    	
        return  messageRepository.findAllByOrderByIdDesc(pageable);
    }
    public Page<Message> findByAuthorIsCurrentUser (Pageable pageable){
    	
        return messageRepository.findByAuthorIsCurrentUser(pageable);
    }
}
